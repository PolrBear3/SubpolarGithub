...
public class CraftNPC_Salvager : CraftNPC
{
    ...
    private void Save_Data()
    {
        ...
        ES3.Save("CraftNPC_Salvager/npcController.foodIcon.AllDatas()", npcController.foodIcon.AllDatas());
    }

    private void Load_Data()
    {
        nuggetBar.Set_Amount(ES3.Load("CraftNPC_Salvager/nuggetBar.currentAmount", nuggetBar.currentAmount));
        npcController.foodIcon.Update_AllDatas(ES3.Load("CraftNPC_Salvager/npcController.foodIcon.AllDatas()", npcController.foodIcon.AllDatas()));
    }
}
